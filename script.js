    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מאיירס שיווק (1981) בע\"מ משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'a24ff744-dcb1-4ff6-867e-f27eeebfc11a',
                    name: data.name || '',
                    email: data.email || '',
